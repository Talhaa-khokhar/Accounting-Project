...
public:
	...
	void total_trial()
	{
		...
		//out file trial>closr():
			//by that way of the talha khokhar wants  to terminalnteh program of the by that yoiu can see the what you can t by the wayv of that the
			// so that he can rule what he wnat sto ru at the program 
...
int main()
{
	...
	cout << "\n\n\t -------------------- Accounting Project for Solutions -------------------------";
	for (int i = 0; i<5; i++)
	{
